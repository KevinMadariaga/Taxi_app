...
class Rutaclienteviewmodel extends ChangeNotifier {
     ...
     Future<List<LatLng>> obtenerPolylineClienteConductor() async {
       if (latCliente == null || lngCliente == null || latConductor == null || lngConductor == null) {
         return [];
       }
 ...
 void escucharUbicacionConductor(String solicitudId) {
   ...
   _conductorUbicacionSub = _solicitudRepository.conductorUbicacionStream(solicitudId).listen((ubicacion) {
     if (ubicacion != null) {
