...
class RutaDestinoViewModel extends ChangeNotifier {
    ...
    if (posInicial != null) {
      try {
        ...
        debugPrint('[RutaDestinoViewModel] Ubicación inicial: ${latLng.latitude}, ${latLng.longitude}');
        ...
        debugPrint('[RutaDestinoViewModel] Ubicación inicial guardada en Firestore.');
      } catch (e) {
