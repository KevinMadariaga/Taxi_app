...
class HistorialDetalleConductor extends StatefulWidget {
  ...
  const HistorialDetalleConductor({Key? key, required this.conductorId})
    : super(key: key);
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
            ...
            try {
              ...
              if (tarifa is Map && tarifa['total'] != null) {
                ...
                if (t is num)
                  ...
                  valor = double.tryParse(t.toString()) ?? 0.0;
              } else if (data['valor'] != null) {
                final v = data['valor'];
                if (v is num)
                  valor = v.toDouble();
                else
                  valor = double.tryParse(v.toString()) ?? 0.0;
              }
          ...
          final String headerDate =
              'Detalle del día • $weekdayCapital ${now.day}';
          ...
          List<List<double>> weekDaySegments = List.generate(
            weekStarts.length,
            (_) => List.filled(7, 0.0),
          );
          for (var d in docs) {
          ...
          List<List<int>> weekDayCounts = List.generate(
            weekStarts.length,
            (_) => List.filled(7, 0),
          );
          for (var d in docs) {
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  const SizedBox(
                    height: 30,
                  ), // espacio entre AppBar y detalle del día
                  ...
                  Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 8),
                        Text(
                          '${todaysRequests.toString()} solicitudes',
                          style: const TextStyle(
                            fontSize: 14,
                            color: AppColores.textSecondary,
                          ),
                  ...
                  const SizedBox(
                    height: 30,
                  ), // espacio entre detalle y el cuadro siguiente
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: Row(
                                ...
                                children: List.generate(weekStarts.length, (i) {
                                  ...
                                  final weekTotal = segments.fold<int>(
                                    0,
                                    (p, e) => p + e,
                                  );
                            ...
                            Row(
                              ...
                              children: [
                                Text(
                                  'Total mes: $monthTotalRequests solicitudes',
                                  style: const TextStyle(
                                    color: AppColores.textSecondary,
                                  ),
                                ),
                                Text(
                                  'Ganado mes: \$$formattedMonthEarnings',
                                  style: const TextStyle(
                                    color: AppColores.textSecondary,
                                  ),
                                ),
                            ...
                            SizedBox(
                              ...
                              child: Column(
                                children: [
                                    ...
                                    child: Stack(
                                      children: [
                                        ...
                                        Align(
                                          ...
                                          child: Builder(
                                            builder: (context) {
                                              final int maxCountInSelectedWeek =
                                                  selectedWeekDayCounts
                                                      .fold<int>(
                                                        0,
                                                        (p, e) => e > p ? e : p,
                                                      );
                                              final double maxForDiv =
                                                  maxCountInSelectedWeek == 0
                                                  ? 1.0
                                                  : maxCountInSelectedWeek
                                                        .toDouble();
                                              return Row(
                                                children: List.generate(7, (i) {
                                                  final count =
                                                      selectedWeekDayCounts[i];
                                                  final bool hasData =
                                                      count > 0;
                                                  final pillColor = hasData
                                                      ? AppColores.primary
                                                      : Colors.grey.shade200;
                                                  final DateTime dayDate =
                                                      weekStarts[selectedWeekIndex]
                                                          .add(
                                                            Duration(days: i),
                                                          );
                                                  final double dayEarnings =
                                                      selectedWeekDayEarnings
                                                              .length >
                                                          i
                                                      ? selectedWeekDayEarnings[i]
                                                      : 0.0;
                                  ...
                                  Row(
                                    children: List.generate(7, (i) {
                                      String dayLabel = DateFormat('E', 'es')
                                          .format(
                                            weekStarts[selectedWeekIndex].add(
                                              Duration(days: i),
                                            ),
                                          )
                                          .replaceAll('.', '');
                            ...
                            SizedBox(
                              ...
                              child: Row(
                                ...
                                children: List.generate(24, (h) {
                                  ...
                                  final max = hourlyEarnings.reduce(
                                    (a, b) => a > b ? a : b,
                                  );
                            ...
                            return ChoiceChip(
                              ...
                              onSelected: (s) {
                                ...
                                if (v == 'semana' && weekStarts.isNotEmpty) {
                                  final int todayWeekIndex = weekStarts
                                      .indexWhere((ws) {
                                        final we = ws.add(
